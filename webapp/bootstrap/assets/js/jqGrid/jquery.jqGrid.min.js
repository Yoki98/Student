                    ...
                    if (this.p.colNames.length !== this.p.colModel.length) alert(b.jgrid.errors.model);
                        ...
                        var o = function (a, b) {
                            ...
                            O = function (c) {
                                if (!a.grid.hDiv.loading) {
                                    ...
                                    else f.npage !== null && delete a.p.postData[f.npage]; if (a.p.grouping) {
                            ...
                            ra = function (c, d) {
                                ...
                                } else f[c].lso = j = f.firstsortorder || "asc"; if (j) {
                                    b("span.s-ico", i).show();
                        ...
                        b("th", i).each(function (d) {
                            ...
                            if (c.length === 1) {
                                ...
                                } else f = ma(this); if (!a.p.viewsortcols[2]) {
                                    e = true;
                                    g = c.attr("sort")
                                }
                            ...
                            if (f[0] && !b[e.p.id].processing) {
                                ...
                                h = a.extend({
                                    ...
                                    complete: function (d, h) {
                                        ...
                                        } else a.isFunction(b[e.p.id].afterSubmit) && (f = b[e.p.id].afterSubmit.call(e, d, n)); if (f[0] === false) {
                            ...
                            c.del && (g = a("<td class='ui-pg-button ui-corner-all'></td>"), t = t || {}, a(g).append("<div class='ui-pg-div'><span class='ui-icon " + c.delicon + "'></span>" + c.deltext + "</div>"), a("tr", f).append(g), a(g, f).attr({
                                ...
                                if (!a(this).hasClass("ui-state-disabled")) {
                                    ...
                                    if (h.p.multiselect) {
                                        b = h.p.selarrrow;
                                        b.length === 0 && (b = null)
                                    } else b = h.p.selrow; if (b) a.isFunction(c.delfunc) ? c.delfunc.call(h, b) : a(h).jqGrid("delGridRow",
                                        b, t);
                                    else {
                                        a.jgrid.viewModal("#" + m.themodal, {
                                            gbox: "#gbox_" + a.jgrid.jqID(h.p.id),
