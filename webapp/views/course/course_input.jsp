							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" method="post" action="save" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="course_name" id="form-field-1" placeholder="course_name" class="col-xs-10 col-sm-5" value="${cou.course_name}"/>
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2">课程学分</label>

										<div class="col-sm-9">
											<input type="text" name="credit" value="${cou.credit}" id="form-field-2" placeholder="credit" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 课程学时 </label>

										<div class="col-sm-9">
											<input type="text" name="course_hour" value="${cou.course_hour}" id="form-field-1" placeholder="course_hour" class="col-xs-10 col-sm-5" />
										</div>
									</div>
