							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" method="post" action="save" enctype="multipart/form-data">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">老师姓名</label>

										<div class="col-sm-9">
											<input type="text" name="name" id="form-field-1" placeholder="Username" class="col-xs-10 col-sm-5" value="${tea.name}"/>
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2">老师密码</label>

										<div class="col-sm-9">
											<input type="password" name="pwd" value="${tea.pwd}" id="form-field-2" placeholder="Password" class="col-xs-10 col-sm-5" />
											
										</div>
									</div>
									
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 老师工号 </label>

										<div class="col-sm-9">
											<input type="text" name="teanum" value="${tea.teanum}" id="form-field-1" placeholder="Username" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 老师头像 </label>
									...
									<div class="form-group">
															<label class="col-sm-3 control-label no-padding-right" for="form-field-1">所教课程</label>
												<div class="col-sm-9">
															<select class="col-xs-10 col-sm-5" id="selectpicker" name="course.id" >
								...
								<div class="form-group">
										...
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">老师性别</label>
										<div class="col-sm-9">
											
												<div class="radio" id="radio_sex">
													<label>
														<input  type="radio" class="ace" name="sex" value="true" <c:if test="${true == tea.sex}">checked</c:if>/>
														<span class="lbl"> 男</span>
													</label>
													<label>
														<input  type="radio" class="ace" name="sex" value="false" <c:if test="${false == tea.sex}">checked</c:if>/>
