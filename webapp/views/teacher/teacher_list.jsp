											...
											<table id="stuTable" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														...
														<th>老师姓名</th>
														<th >老师性别</th>
														<th class="hidden-480">老师工号</th>
														<th class="hidden-480">所教课程</th>
														<th>
												...
												<c:forEach items="${teacher}" var="tea">
													<tr>
														...
														<td>${tea.teanum}</td>
														<td>${tea.course.course_name}</td>

														<td class="hidden-480">
															<span >
																
																<img style="width:60;height:60px;"  src="${tea.imgUrl}" />
															</span>
														</td>
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																...
																<a class="green" href="edit?id=${tea.id}" title="edit">
																	<i class="icon-pencil bigger-130"></i>
																</a>
	
																<a class="red" href="delete?id=${tea.id}" title="delete">
